...
<div class='container' id="main">
	...
	<div class="lang_link">
		<a href="bangla_channel_list.php" class="btn btn-primary" role="button">Bengali</a>
		<a href="hindi_channel_list.php" class="btn btn-default" role="button">Hindi</a>
		<a href="english_channel_list.php" class="btn btn-default" role="button" id="eng_chan">English</a>
	</div>
	 <!--<h1 id="top">Popular Channels</h1> -->
<h1 id='channel_atn'>&#8226; ATN Bangla</h1>
<?php
	for($i=0;$i<5;$i++){ ?>
<div class="channel_list">
	...
	<div class="info">
		<p id='title'><a href="ben_show_detail.php?id=<?php echo $data[$i]['id'];?>"><?php echo $data[$i]['title'];?></a></p>
		<div id="actor">
...
<h1 id='channel_zee'>&#8226; Zee Bangla</h1>
<?php
	for($i=18;$i<23;$i++){ ?>
<div class="channel_list">
	<div class="image_content">
...
<?php } ?>		
	...
	<h1 id='channel_btv'>&#8226; Bangladesh Television</h1>
<?php
	for($i=5;$i<10;$i++){ ?>
<div class="channel_list">
	<div class="image_content">
...
<?php } ?>	
	...
	<h1 id='channel_colors'>&#8226; Colors Bangla</h1>
<?php
	for($i=13;$i<18;$i++){ ?>
<div class="channel_list">
	<div class="image_content">
...
<?php } ?>	
	...
	<h1 id='channel_jalsha'>&#8226; Star Jalsha</h1>
<?php
	for($i=23;$i<27;$i++){ ?>
<div class="channel_list">
	<div class="image_content">
...
<?php } ?>	
<h1 id='channel_jalsha'>&#8226; SONY আট</h1>
<?php
	for($i=27;$i<29;$i++){ ?>
<div class="channel_list">
	<div class="image_content">
