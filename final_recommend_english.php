      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="final_recommend_english.php" id="home">Recommendation</a></li>
					<li class="dropdown">
...
<div class="container" id="main">
				...
				<div class="form-group">
					...
					<div class="col-sm-12" style="margin-top:-5px;margin-bottom:15px;">
							<div class="col-sm-4">
								...
								<div class="radio">
									<input type="radio" name="type" value="14">Talk Show
								</div>
							</div>	
							<div class="col-sm-4">
								<div class="radio">
									<input type="radio" name="type" value="9">Animation
								</div>
							</div>
							<div class="col-sm-4">
								<div class="radio">
				...
				<div class="form-group" style="margin-top:30px;">
					...
					<div class="col-sm-12" style="margin-top:-5px;margin-bottom:15px;">
						<div class="col-sm-4">
							...
							<div class="radio">
								<input type="radio" name="genre" value="5">Mystery
							</div>							
							<div class="radio">
								<input type="radio" name="genre" value="6">Thriller
							</div>							
						</div>	
						<div class="col-sm-4">
							<div class="radio">
								<input type="radio" name="genre" value="7">Reality
							</div>
							<div class="radio">
								<input type="radio" name="genre" value="10">Adventure
							</div>
							<div class="radio">
								<input type="radio" name="genre" value="11">Fantasy
							</div>
							<div class="radio">
								<input type="radio" name="genre" value="12">Action
							</div>
						</div>
						<div class="col-sm-4">
							<div class="radio">
								<input type="radio" name="genre" value="13">Crime
							</div>
							<div class="radio">
								<input type="radio" name="genre" value="15">Horror
							</div>
							<div class="radio">
								<input type="radio" name="genre" value="16">Sci-Fi
							</div>
							<div class="radio">
								<input type="radio" name="genre" value="17">History
							</div>
						</div>
					</div>
				</div>					
    ...
    <div class="col-sm-9" id="show_list"> <!--style="background-color:lavenderblush;"-->
		<?php
			include 'english_recommendation.php';
		?>
		<div class='container-fluid'>
		<div class="lang_link">
			<a href="final_recommend_bangla.php" class="btn btn-default" role="button">Bengali</a>
			<a href="final_recommend_hindi.php" class="btn btn-default" role="button">Hindi</a>
			<a href="final_recommend_english.php" class="btn btn-primary" role="button" id="eng_chan">English</a>
		</div>
		<?php 
		...
		for($i=0;$i<$_COOKIE['length'];$i++){ 
			...
			$id = file_get_contents('https://www.omdbapi.com/?i='.$final_list[$i].'&type=series&y=&r=json');
			$id = json_decode($id, TRUE);
			$data = file_get_contents('https://api.themoviedb.org/3/find/'.$final_list[$i].'?api_key=2f13f07242bf72239c2dd119a7f302ee&language=en-US&external_source=imdb_id');
		...
		<div class="info">
			<p id='title'><a href="series_detail.php?id_imdb=<?php echo $id['imdbID'];?>&id_tmdb=<?php echo $data['tv_results'][0]['id'];?>"><?php echo $id['Title'];?></a></p>
			<?php 
				if(isset($result)){
...
<script>
	function jsfunction(value){
				...
				window.location = './final_recommend_english.php';
