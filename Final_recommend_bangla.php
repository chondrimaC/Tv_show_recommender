...
<div class="container" id="main">
			...
			<form method="POST" id="myform">
				...
				<div class="col-sm-12" style="margin-top:-5px;margin-bottom:15px;">
						<div class="col-sm-4">
							...
							<div class="radio">
								<input type="radio" name="genre" value="9">Supernatural
							</div>							
						</div>	
						<div class="col-sm-4">
							<div class="radio">
						...
						<div class="col-sm-4">
							<div class="radio">
								<input type="radio" name="genre" value="11">Adventure
							</div>
							<div class="radio">
								<input type="radio" name="genre" value="12">Fantasy
							</div>
							<div class="radio">
								<input type="radio" name="genre" value="13">Detective
							</div>
						</div>
					</div>
				</div>					
    ...
    <div class="col-sm-9" id="show_list"> <!--style="background-color:lavenderblush;"-->
		<?php
			include 'bangla_recommendation.php';
		?>
		<div class='container-fluid'>
		<div class="lang_link">
			<a href="final_recommend_bangla.php" class="btn btn-primary" role="button">Bengali</a>
		...
		<?php 
			...
			echo "Please answer the questions on the left and also rate at least 5 tv show";
		}
		?>
		...
		<div class="info">
			<p id='title'><a href="ben_show_detail.php?id=<?php echo $id[$i];?>" ><?php echo $title[$i];?></a></p>
			<?php 
			if(isset($result)){
			...
			$("#myform").submit(function(e) {
				...
				$.ajax({
					   ...
					   success: function(data)
					   {
						   ...
						   window.location = './final_recommend_bangla.php';
					   }
					 });
