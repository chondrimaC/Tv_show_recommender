...
<div class='container' id="main">
	...
	<div class="channel_link">
		<a href="english_channel_list.php" class="btn btn-primary" role="button" id="world">Star World</a>
		...
		<a href="english_channel_fox.php" class="btn btn-default" role="button" id="fox">Fox</a>
	...
	<h1 id='channel_world'>Star World</h1>
<?php
	for($i=0;$i<10;$i++){ 
