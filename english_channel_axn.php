...
<div class='container' id="main">
	...
	<div class="channel_link">
		...
		<a href="english_channel_axn.php" class="btn btn-primary" role="button" id="axn">AXN</a>
...
<div class="channel_list">
	...
	<div class="info">
		<p id='title'><a href="series_detail.php?id_imdb=<?php echo $id['imdbID'];?>&id_tmdb=<?php echo $ID_tmdb[$i];?>"><?php echo $id['Title'];?></a></p>
		<div id="actor">
